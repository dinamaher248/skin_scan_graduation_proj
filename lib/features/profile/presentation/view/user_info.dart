    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
          ...
          CircleAvatar(
            radius: 9.w,
            backgroundImage: const AssetImage('Images/profile pic.png'),
          ),
          Text('User Name',
                    ...
                    child:  ListTile(
                      ...
                      title: Padding(
                        ...
                        child: Text(
                          'Age',
                          style:
                              TextStyle(fontSize: 13.sp, color: const Color(0xFF989898)),
                        ),
                      ),
                    ),
                  ),
                    ...
                    child:  ListTile(
                      ...
                      title: Padding(
                        ...
                        child: Text(
                          'gender',
                          style:
                              TextStyle(fontSize: 14.sp, color: const Color(0xFF989898)),
                        ),
                      ),
                    ),
                  ),
